...
const MovieList = () => {
    ...
    const handleDetails = movies => {
        ...
        //jodi ekta item click kore shei item abar click korle jate show na kore ar oi jnne ei functionality
        // const existingMovie = details.find(mov => mov.key === movie.key)
        // if (!existingMovie) {
            // const newMovies = [...details, movie]
